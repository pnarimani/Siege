...
{
    public class BuildingDefinitionService
    {
        readonly Dictionary<BuildingType, BuildingDefinition> _definitions = new();

        public BuildingDefinitionService()
        {
            InitializeDefinitions();
        }

        public BuildingDefinition Get(BuildingType type) => _definitions[type];

        public IReadOnlyDictionary<BuildingType, BuildingDefinition> All => _definitions;

        void Register(BuildingDefinition def) => _definitions[def.Type] = def;
